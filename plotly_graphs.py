...
def twod_historgram(lst1, lst2, cts_, par_1, par_2):
    fig = go.Figure(go.Histogram2d(colorscale='Viridis', x=lst1, y=lst2, z=cts_))
...
if __name__ == '__main__':
    ...
    # the below block of code makes a scatter plot.
    dict_counts('JC-202403-citibike-tripdata.csv',
                'start_station_name',
    ...
    # the below block of code makes a 2d histogram.
    d1 = {}
    dict_counts('JC-202403-citibike-tripdata.csv',
                rt,
                ssn,
    ...
    for f in d1.values():
        cts1.append(f)
    twod_historgram(rideable_type, start_station, cts1, rt, ssn)
